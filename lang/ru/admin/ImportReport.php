...
$MESS['KO_EXPORTIMPORT_TITLE_IMPORT'] = 'Импорт логов добавленных, измененых и удаленных элементов Highload-блока';
...
$MESS['KO_EXPORTIMPORT_IMPORT_CLUCH'] = 'Поле внешнего ключа (выберите уникальный ключ, например UF_XML_ID)';
// $MESS['KO_EXPORTIMPORT_IMPORT_CLUCH'] = 'Поле уникального ключа (по которому модуль будет искать элементы)';
...
$MESS['KO_EXPORTIMPORT_INFO_2'] = 'В параметре указывается уникальное поле из импортируемого файла,'
	. ' по значениям которого будет выполняться поиск и обновление записей, например  <b>UF_XML_ID</b> в highload-блоке. Если запись найдена, '
...
$MESS['KO_EXPORTIMPORT_ADD_MISSING'] = 'Создавать отсуствующие элементы при экспорте';
$MESS['KO_EXPORTIMPORT_INFO_3'] = 'В том случае если в файле импорта есть элемент, который отсутсвует на сайте, он будет создан как новый';
