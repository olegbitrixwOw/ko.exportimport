<?php
$MESS['KO_EXPORTIMPORT_TITLE'] = 'Импорт данных Highload-блока из CSV';
$MESS['KO_EXPORTIMPORT_TITLE_IMPORT'] = 'Импорт данных Highload-блока';
...
$MESS['KO_EXPORTIMPORT_IMPORT_CLUCH'] = 'Поле внешнего ключа (выберите пункт ID)';
