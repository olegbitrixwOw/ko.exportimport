...
$aTabs = array(
	array(
		'DIV' => 'export',
		'TAB' => Loc::getMessage('KO_EXPORTIMPORT_TITLE_EXPORT'),
		'TITLE' => Loc::getMessage('KO_EXPORTIMPORT_TITLE_EXPORT')
	)
);
...
<form name="form_tools" method="POST" action="/bitrix/admin/KO_exportimport_ajax.php" id="KO_exportimport_form">
	...
	?>
	<tr class="heading">
		<td colspan="2"><?= Loc::getMessage('KO_EXPORTIMPORT_EXPORT_O_SET')?></td>
	</tr>
	<!-- <tr>
		<td width="40%"><?= Loc::getMessage('KO_EXPORTIMPORT_FIELD_EXPORT_FILE')?>:</td>
		<td>
			<input type="text" id="url_data_file" size="30" value="/upload/Brand.csv" name="url_data_file" />
